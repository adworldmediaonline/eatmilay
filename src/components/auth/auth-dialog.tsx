    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[480px] w-[calc(100vw-2rem)] max-h-[90vh] overflow-x-hidden overflow-y-auto p-0 gap-0 bg-gradient-to-br from-white to-gray-50">
        <DialogHeader className="px-4 sm:px-6 pt-6 pb-4 border-b">
          <DialogTitle className="text-xl sm:text-2xl font-bold text-center text-[#19302a]">
        ...
        >
          <div className="px-4 sm:px-6">
            <TabsList className="grid w-full grid-cols-2 mb-4 mt-4 h-11 bg-gray-100 p-1">
              <TabsTrigger
                value="signin"
                className="text-gray-700 data-[state=active]:bg-[#19302a] data-[state=active]:text-white transition-all duration-300 rounded-md data-[state=active]:shadow-md text-sm sm:text-base font-medium"
              >
                Sign In
              </TabsTrigger>
              <TabsTrigger
          ...
          <div className="px-4 sm:px-6 pb-6 pt-2 border-t bg-gray-50/50">
            <p className="text-xs text-center text-gray-600 break-words">
              ...
              <a href="#" className="underline hover:text-[#19302a] transition-colors">
                Terms of Service
              </a>{' '}
              and{' '}
              <a href="#" className="underline hover:text-[#19302a] transition-colors">
