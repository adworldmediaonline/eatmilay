            ...
            <div className="grid gap-6">
              ...
              <div className="text-center text-sm">
                ...
                {inDialog && onSwitchToSignIn ? (
                  <button type="button" onClick={onSwitchToSignIn} className="underline underline-offset-4 font-medium transition-colors text-white py-1 px-2">
                    Sign in
                  </button>
                ) : (
                  <Link href="/sign-in" className="underline underline-offset-4 font-medium transition-colors text-white py-1 px-2">
                    Sign in
                  </Link>
                )}
              </div>
